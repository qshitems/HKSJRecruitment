...
{
    public class Report_CreatestatisticsdayMap : EntityTypeConfiguration<Report_Createstatisticsday>
    {
        public Report_CreatestatisticsdayMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Report_Createstatisticsday");
